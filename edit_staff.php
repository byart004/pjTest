<?php
  ...
  $id=$_REQUEST['id'];
  $select1 = "select * from staff where id='$id' ";
...
<div class="col-md-9">
 ...
 <div class="col-md-12">
 <div class="panel panel-info">
   <div class="panel-heading" align="center" ><h2>แก้ไขข้อมูลพนักงาน</h2></div>
   <div class="panel-body">
       </body>
...
<div class="col-md-8" style="border: 1px solid Navy;">
        <form action="" method="post"  enctype="multipart/form-data">
          ...
          <br><br>
          <center><button type="submit" name ="submit">แก้ไขข้อมูลพนักงาน </button></center>
          <br><br>
        </form>
...
<?php
  if(isset($_POST["submit"])){
      ...
      echo "<script>location.href='table_staff.php';</script>";
