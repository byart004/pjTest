...
<div class="col-md-9">
 ...
 <div class="col-md-12">
 <div class="panel panel-info">
	 <div class="panel-heading" align="center" ><h2>ตารางเครื่องออกกำลังกาย</h2></div>
	 <div class="panel-body">
		 <form method="post" action="chk_login.php">
			 </body>
			...
			<div class="panel-heading">
				<table class="table table-bordered table-striped ">
				 ...
				 <tr>
					   ...
					   <th class="text-nowrap">รหัสครื่อง</th>
					   <th class="text-nowrap">วันเดือนปีที่นำเข้า </th>
					 </tr>
				   </thead>
				   <tbody>
					 <tr>
					 <button <a href="home.php" type="button" class="btn btn-primary"><a href="add_training_equipment.php"> <font color="#FFFFFF"> เพื่มข้อมูลเครื่องออกกำลังกาย</font></a> </button> <br></br>
					   <?php
					  $i=0;

					  $select1 = "select * from machine ";
