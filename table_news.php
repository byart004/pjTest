...
<div class="col-md-3">
   ...
   <div class="panel panel-info">
     ...
     <div class="panel-body">
	   ...
	   <div class="col-md-12">
	   <div class="panel panel-info">
	     <div class="panel-heading" align="center" ><h2>ตารางข้อมูลสมาชิก</h2></div>
	     <div class="panel-body">
	       <form method="post" action="chk_login.php">
	         </body>
	        ...
	        <div class="panel-heading">
	          <table class="table table-bordered table-striped ">
	           ...
	           <tr>
					   ...
					   <th class="text-nowrap">หัวข้อข่าว</th>
					   <th class="text-nowrap">เนื้อหา</th>
             <th class="text-nowrap">รูปภาพ</th>
				   ...
				   <tbody>
					 <tr>
					 <button <a href="home.php" type="button" class="btn btn-primary"><a href="add_news.php"> <font color="#FFFFFF"> เพื่มข้อมูลข่าวสาร</font></a> </button> 
           <button <a href="home.php" type="button" class="btn btn-primary"><a href="table_rule.php"> <font color="#FFFFFF"> การจัดการกฎในการเข้าใช้ศูนย์</font></a> </button>
            ...
            <td width="200"><img src="admin/image/<?php echo $row['pic'];?>" width="100" height="100"></td>
						 <td> <a href="delete_news.php?id=<?php echo $row1['id'];?>">
          <span class="glyphicon glyphicon-trash"></span>
        </a></td>
            <td><a href="edit_news.php?id=<?php echo $row1['id'];?>">
          <span class="glyphicon glyphicon-pencil"></span>
        </a></td>
            <td><a href="check_news.php?id=<?php echo $row1['id'];?>">
