...
<div class="container-fluid">
   ...
   <li class="active"><a href="home1.php">หน้าแรก</a></li>
...
<div class="col-md-9">
 ...
 <div class="col-md-12">
 <div class="panel panel-info">
   <div class="panel-heading" align="center" ><h2>ลงทะเบียนชำระเงิน</h2></div>
   <div class="panel-body">
     <form method="post" action="check_member.php">
          ...
          while($row1=mysqli_fetch_array($result1)){
            ...
            <td ><?php echo $row1['name_surname']; ?></td>
            <td ><?php echo $row1['category']; ?></td>
            <td ><?php echo $row1['owe']; ?></td>
            <td ><?php echo $row1['birthday_owe']; ?></td>
            <td ><?php echo $row1['Status']; ?></td>
            <td><a href="delete.php?id=<?php echo $row1['id'];?>">Del</a></td>
            <td><a href="edit_training.php?id=<?php echo $row1['id'];?>">edit</td>
            <td><a href="check.php<?php echo $row1['id'];?>">check</td>
