...
<div class="col-md-12">
 ...
 <div class="col-md-12">
 <div class="panel panel-info">
   <div class="panel-heading" align="center" ><h2>แก้ไขข้อมูลการสมัครสมาชิก</h2></div>
   <div class="panel-body">
       </body>
...
<div class="col-md-8" style="border: 1px solid Navy;">
        <form action="" method="post"  enctype="multipart/form-data">
          ...
          <br><br>
            ...
            <input type="text" name ="username"  value="<?= $row1['username']; ?>">
          <br><br>
            <label class="control-label col-sm-5" for="sc_id">รหัสผ่าน : </label>
            <input type="password" name ="password" value="<?= $row1['password']; ?>">
          <br><br>
          ...
          <br><br>
          <center><button type="submit" name ="submit">แก้ไขข้อมูลการสมัคร </button></center>
          <br><br>
...
<?php
  if(isset($_POST["submit"])){
      ...
      $update=" update member
            set name='$name',studentid ='$stuid',birthday='$bd',phonenumber='$phone',
