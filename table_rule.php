    ...
    <div class="panel panel-info"> 
     <div class="panel-body"> 
      <div class="col-md-12"> 
       <div class="panel panel-info"> 
        <div class="panel-heading" align="center">
         <h2>ตารางกฎในการเข้าใช้ศูนย์วิทยาศาสตร์การกีฬาและสุขภาพ </h2>
        </div> 
        <div class="panel-body"> 
         <form method="post" action="chk_login.php">  
          <article> 
           <div class="panel panel-Default"> 
            <div class="panel-heading"> 
             <button <a="" href="home.php" type="button" class="btn btn-primary"><a href="add_news.php"> <font color="#FFFFFF"> เพื่มกฎ</font></a> </button>
             <br />
             <br />
            ...
            ?> 
               ...
               <tr> 
                <td>
                 <?php echo $i; ?></td> 
                <td>
                 <?php echo  $row1['What']; ?></td> 
                <td> <a href="delete_rule.php?id=&lt;?php echo $row1['id'];?&gt;"> <span class="glyphicon glyphicon-trash"></span> </a></td> 
                <td><a href="edit_rule.php?id=&lt;?php echo $row1['id'];?&gt;"> <span class="glyphicon glyphicon-pencil"></span> </a></td> 
               </tr> 
               <?php }   ?>  
              </tbody>
             </table> 
   ...
   <div class="row"> 
    <div class="col-md-12"> 
     <div class="panel panel-default"> 
      <div class="panel-heading"> 
       <center>
         ระบบบริหารจัดการศูนย์วิทยาศาสตร์การกีฬาและสุขภาพ มหาวิทยาลัยราชภัฏยะลา 
       </center>  
      </div> 
     </div> 
    </div>
