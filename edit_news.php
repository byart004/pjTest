...
<div class="col-md-9">
 ...
 <div class="col-md-12">
 <div class="panel panel-info">
   <div class="panel-heading" align="center" ><h2>แก้ไขข้อมูลข่าวสาร</h2></div>
   <div class="panel-body">
       </body>
...
<article>
      ...
      <div class = "detail">
        ...
        <br><br>
          ...
          <textarea name="detail" rows="5" cols="50<?= $row1['detail']; ?>"></textarea>
        <br><br>
          <label class="control-label col-sm-3" for="sc_id">วันเดือนปีที่ลงข่าว  </label>
          <input type="date" name ="date">
        <br><br>
          <label class="control-label col-sm-3" for="sc_id">เลือกรูปถ่าย  </label>
           <input type="hidden" name ="txtname">
        <input type="file" name ="fileupload">
          <br><br>
          <center><button type="submit" name ="submit">แก้ไขข้อมูลข่าวสาร </button></center>
          <br><br>
        </form>
...
<?php
  if(isset($_POST["submit"])){
      ...
      echo "<script>location.href='table_news.php';</script>";
