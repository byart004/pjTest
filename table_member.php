        ...
        <div class="panel-heading">
          <table class="table table-bordered table-striped ">
           ...
           <tr>
             ...
             <th class="text-nowrap">รหัสนักศึกษา/บุคลากร </th>
           ...
           <tbody>
           <tr>
           <button <a href="home.php" type="button" class="btn btn-primary"><a href="add_member.php"> <font color="#FFFFFF"> เพื่มข้อมูลสมาชิก </font></a> </button> <br></br>
             <?php
            $i=0;

            $select1 = "select * from member where status = 'no' ";
