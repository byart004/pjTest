...
<div class="col-md-3">
   ...
   <div class="panel panel-info">
     ...
     <!-- Centered Tabs -->
           ...
           <br></br>
             <a href="table_payment.php"><span class="glyphicon glyphicon-bitcoin"> ชำระเงิน </span></a>
           <br></br>
...
<div class="col-md-9">
 ...
 <div class="col-md-12">
 <div class="panel panel-info">
	 <div class="panel-heading" align="center" ><h2>กฎในการเข้าใช้</h2></div>
	 <div class="panel-body">

		<article>
			<center><h3></h3></center>
			<div class = "detail">
					<label class="control-label col-sm-3" for="sc_id">กฎในการเข้าใช้ </label>
					<form action="" method="post"  enctype="multipart/form-data">
					<input type="text" name ="What" placeholder="">
				<br><br>
 ...
 <div class="col-md-12">
  ...
  if(isset($_POST["submit"])){
    ...
    if($_POST["What"]!="")
    {
      ...
      $What=$_POST["What"];
      mysqli_query($conn,"INSERT INTO rule VALUES
      ('','$What')");      
      echo "<script>alert('บันทึกข้อมูลสำเร็จ'); location.href='rule.php'</script>";
    }
    else
