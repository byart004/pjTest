 ...
 <body> 
  ...
  <table class="table table-bordered">
    ...
    <tr class="warning">
      ...
      <table class="table table-bordered">
           <tr class="info">
             <a href="rule1.php"><span class="glyphicon glyphicon-pushpin"> กฎในการเข้าใช้ศูนย์วิทยาศาสตร์การกีฬาและสุขภาพ มหาวิทยาลัยราชภัฏยะลา</span></a>
              <br><br>
  ...
  <div class="col-md-8">
    <div class="panel panel-info">
      <div class="panel-heading" align="center" ><h4><marquee direction="left">ศูนย์วิทยาศาสตร์การกีฬาและสุขภาพ มหาวิทยาลัยราชภัฏยะลา</marquee></h4></div>
        <div class="panel-body"> 
         <form method="post" action="chk_login.php">  
          <article> 
           <div class="panel panel-Default"> 
            <div class="panel-heading"> 
             <center><h3>กฎในการเข้าใช้ศูนย์วิทยาศาสตร์การกีฬาและสุขภาพ มาหวิทยาลัยราชภัฏยะลา</h3></center>
             <br />
