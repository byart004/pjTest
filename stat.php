   ...
   <div class="panel panel-info">
     ...
     <div class="panel-body">
       <form method="post" action="chk_login.php">
		...
		<div class="col-md-12">
		<div class="panel panel-info">
		<div class="panel-heading" align="center" ><h2>ข้อมูลรายรับ-รายจ่าย</h2></div>
		<div class="panel-body">
			...
			<div class="panel panel-Default">
				<div class="panel-heading">
					<form action="" method="post"  enctype="multipart/form-data">
						เงื่อนไขการค้นหา</br></br>
						ตั้งแต่วันที่  <input type="date" name="start"/>
						ถึงวันที่ <input type="date" name="end" />
						<center><button type="submit" name ="submit">ค้นหา </button></center>
					</form>
					...
					<thead>
					   <tr>
							...
							<th class="text-nowrap">จำนวนเงินรายรับ </th>
							<th class="text-nowrap">จำนวนเงินรายจ่าย</th>
							<th class="text-nowrap">จำนวนเงินคงเหลือ</th>
					   </tr>
					 </thead>
					 <tbody>
					 <?php
...
<?php
	if($_POST){
		if($_POST['start']!="" && $_POST['end']!=""){
			...
			$select1 = "select * from stat where date between '$start' and '$end' ";
