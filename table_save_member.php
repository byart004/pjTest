...
<div class="col-md-3">
   ...
   <div class="panel panel-info">
     ...
     <div class="panel-body">
	   ...
	   <div class="col-md-12">
	   <div class="panel panel-info">
	     <div class="panel-heading" align="center" ><h2>ข้อมูลรายจ่าย</h2></div>
	     <div class="panel-body">
	       <form method="post" action="chk_login.php">
	         </body>
      ...
      <div class="col-sm-6 text-center">
        <li><a href="expenses.php"><img src="img/ButtonR1.jpg" class="img-responsive" style="width:100%" alt="Image"></a></li>
      </div>

      <div class="col-sm-6 text-center">
        <li><a href="stat.php"><img src="img/ButtonR2.jpg" class="img-responsive" style="width:100%" alt="Image"></a></li>
      </div>
