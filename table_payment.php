...
<div class="col-md-9">
 ...
 <div class="col-md-12">
 <div class="panel panel-info">
   <div class="panel-heading" align="center" ><h2>สมาชิกที่ชำระเงินแล้ว</h2></div>
   <div class="panel-body">
        ...
        <table class="table table-bordered table-striped ">
         ...
         <tr>
           ...
           <tr>
             ...
             <button <a href="home.php" type="button" class="btn btn-primary"><a href="expenses.php"> <font color="#FFFFFF"> รายรับรายจ่าย </font></a> </button> <br></br>
             <button <a href="home.php" type="button" class="btn btn-primary"><a href="stat.php"> <font color="#FFFFFF"> บันทึกรายจ่าย </font></a> </button> <br></br>
            <?php
            $i=0;

            $select1 = "select * from member where status='yes'";
