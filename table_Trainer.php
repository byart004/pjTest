...
<div class="col-md-9">
 ...
 <div class="col-md-12">
 <div class="panel panel-info">
   <div class="panel-heading" align="center" ><h2>ตารางข้อมูลครูฝึก</h2></div>
   <div class="panel-body">
     <form method="post" action="chk_login.php">
       </body>
      ...
      <div class="panel panel-Default">
        <div class="panel-heading">
          <table class="table table-bordered table-striped ">
           ...
           <tbody>
           <tr>
           <button <a href="home.php" type="button" class="btn btn-primary"><a href="add_Trainer.php"> <font color="#FFFFFF"> เพื่มข้อมูลครูผู้ฝึก </font></a> </button> <br></br>
             <?php
            $i=0;

            $select1 = "select * from trainer ";
          ...
          while($row1=mysqli_fetch_array($result1)){
            ...
            <td><a href="delete_Trainer.php?id=<?php echo $row1['id'];?>">
          <span class="glyphicon glyphicon-trash"></span>
        </a></td>
            <td><a href="edit_Trainer.php?id=<?php echo $row1['id'];?>">
          <span class="glyphicon glyphicon-pencil"></span>
        </a></td>
            <td><a href="check_trainer.php?id=<?php echo $row1['id'];?>">
