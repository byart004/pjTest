...
<div class="container-fluid">
    ...
    <a class="navbar-brand" href="home.php"><i class="fa fa-home">หน้าแรก</i> </a>
    </div>
		  ...
		  <br>
            ...
            <div class="panel-body">
              <form method="post" action="chk_login.php">
                ...
                <center><button type="submit" class="btn btn-primary" ><span class="glyphicon glyphicon"></span> เข้าสู่ระบบ</button></center>
              </form>
            </div>
          </div>
        </div>
