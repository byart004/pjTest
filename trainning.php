...
รหัสพนักงาน
วันเดือนปีที่ตรวจสภาพ
					รหัสพนักงาน : <input type="text" name ="name" placeholder="ชื่อ-สกุล">
					<br><br>
					รหัสนักศึกษา  : <input type="text" name ="studentid" placeholder="รหัสนักศึกษา">*กรณีเป็นนักศึกษา 
					<br><br>
					วันเดือนปีที่นำเข้า : <input type="date" name ="birthday">
					<br><br>
					วันเดือนปีที่ตรวจสภาพ: <input type="date" name ="birthday">
					<br><br>
					...
					<br><br>
					ชื่อผู้ใช้ : <input type="text" name ="username" placeholder="ชื่อผุ้ใช้">
					<br><br>
